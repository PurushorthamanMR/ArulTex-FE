    ...
    <div className="transaction-report-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">View or re-print anytime (staff)</p>
        </div>
            ...
            {loading ? (
              ...
              list.map((row, idx) => (
                <tr key={row.id}>
                  ...
                  <td>{row.closedBy ? `${row.closedBy.firstName} ${row.closedBy.lastName}` : '—'}</td>
                ...
                <>
                  <div className="detail-grid" style={{ marginBottom: '16px' }}>
                    ...
                    <div className="detail-item">
                      ...
                      <span>{detail.closedBy ? `${detail.closedBy.firstName} ${detail.closedBy.lastName}` : '—'}</span>
                    </div>
                    <div className="detail-item">
